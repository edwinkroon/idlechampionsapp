...
RECORDS: dict[int, dict] = {
    ...
    81: {
        ...
        "conditionals": [
            ...
            {
                "when": "tier1 continues Avenger branch (canonical lowest id)",
                "upgrade_id": 13753,
                "name": "Relentless Avenger",
            },
            {
                "when": "tier1 continues Shield branch (canonical lowest id)",
                "upgrade_id": 13754,
                "name": "Reflective Shield",
            },
            {
                "when": "tier1 continues Skin branch (canonical lowest id)",
                "upgrade_id": 13756,
                "name": "Mithral Skin",
            },
        ],
        ...
        "sources": {
            ...
            "csv_advice_text": "Tier1 reuses names; advice pins lowest upgrade_id per name.",
        },
        "explanation_summary": "Safe Mithral Skin; tier1 duplicates resolved to lowest upgrade_id per name.",
        "review_needed": False,
        "review_reasons": [],
    },
    83: {
    ...
    165: {
        ...
        "sources": {
            "csv_default_label": None,
            "csv_label_maps_to": None,
            "csv_advice_text": "Tier1 reuses deity names across branch ids; advice pins lowest id per name.",
        },
        "explanation_summary": "Safe Bargain With Eldath; tier1 duplicates resolved to lowest upgrade_id per name.",
        "review_needed": False,
        "review_reasons": [],
    },
    166: {
