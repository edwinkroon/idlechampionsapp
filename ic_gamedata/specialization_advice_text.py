...
_FORMATION_REASONS: tuple[tuple[str, str], ...] = (
    ...
    ("BUD/top damage is melee", "Deze keuze matcht Ruby Weakness op melee omdat je BUD/top damage melee aanvalt — monsters nemen dan 100% meer melee-schade."),
    ("BUD/top damage is ranged", "Deze keuze matcht Ruby Weakness op ranged omdat je BUD/top damage ranged aanvalt — monsters nemen dan 100% meer ranged-schade."),
    ("BUD/top damage is magic", "Deze keuze matcht Ruby Weakness op magic omdat je BUD/top damage magic aanvalt — monsters nemen dan 100% meer magic-schade."),
    ("melee-aanvallers → Ruby Weakness", "Deze keuze wordt gebruikt omdat de actieve formatie vooral melee-aanvallers heeft; Ruby Weakness (Melee) laat enemies meer melee-schade nemen."),
    ("ranged-aanvallers → Ruby Weakness", "Deze keuze wordt gebruikt omdat de actieve formatie vooral ranged-aanvallers heeft; Ruby Weakness (Ranged) laat enemies meer ranged-schade nemen."),
    ("magic-aanvallers → Ruby Weakness", "Deze keuze wordt gebruikt omdat de actieve formatie vooral magic-aanvallers heeft; Ruby Weakness (Magic) laat enemies meer magic-schade nemen."),
    ("BUD staat vóór Regis → Ahead", "Deze keuze bufft de kolom vóór Regis omdat je BUD daar staat."),
    ("BUD staat achter Regis → Behind", "Deze keuze bufft de kolom achter Regis omdat je BUD daar staat."),
    ("Cazrin is huidige top damage → Signature Smell", "Deze keuze is voor DPS-Cazrin: Signature Smell stuurt Uggie's buffs naar Cazrin zelf in plaats van naar de rest van de party."),
    ("Cazrin als support → Smell Mastery", "Deze keuze is voor support-Cazrin: Smell Mastery verdubbelt de per-Book bonus van In Search of Knowledge op Sunny Disposition."),
    ...
    ("evil → The Dark Hunger", "Deze keuze verhoogt het max aantal Accursed Specters tot het aantal evil champions in je formatie."),
    ("DEX≥16 → Shadows in the Night", "Deze keuze verhoogt het max aantal Accursed Specters tot het aantal champions met DEX 16+ in je formatie."),
    ("CHA-hoogst → Charm of the Fallen", "Deze keuze verhoogt het max aantal Accursed Specters tot het aantal champions met Charisma als hoogste ability score."),
    ("geen specter-data; default The Dark Hunger", "Geen bruikbare alignment/ability-telling beschikbaar; fallback is de guide-default The Dark Hunger."),
